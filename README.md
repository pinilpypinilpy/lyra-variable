...
5. While quality might be the same as normal lyra v2 when using 16khz and presets 1-3, anything outside of that is unfamiliar ground. I am not responsible if you damage your hearing.
----------------------------------
## What is Lyra?
