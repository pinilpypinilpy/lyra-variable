...
5. While quality might be the same as normal lyra v2 when using 16khz and presets 1-3, anything outside of that is unfamiliar ground to the model doing the encoding. I am not responsible if you damage your hearing somehow.
----------------------------------
## What is Lyra?
